...
public class AddStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Department.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select:", "CCIS", "CEDAS", "CABE", "CHS", "COE" }));
    ...
    private void btnSAVEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSAVEActionPerformed
      ...
      try {
            ...
            if (fname.isEmpty() || lname.isEmpty() || id.isEmpty() || course.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please fill in all text fields.");
                return;
            }

            if (gender.equals("Select:") || department.equals("Select:")) {
                JOptionPane.showMessageDialog(null, "Please select a valid Gender and Department.");
                return;
            }

            String data = fname + ",\t" + lname + ",\t" + gender + ",\t" + id + ",\t" + course + ",\t" + department + "\n";

            String folderPath = "C://CJC_SIS/";

            FileWriter allWriter = new FileWriter(folderPath + "AllStudents.txt", true);
            allWriter.write(data);
            allWriter.close();

            String deptFile = folderPath + department + ".txt";  
            FileWriter deptWriter = new FileWriter(deptFile, true);
            deptWriter.write(data);
            deptWriter.close();
